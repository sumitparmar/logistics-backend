...
const publicDriverOnboardingSchema = new mongoose.Schema(
  {
    status: {
      type: String,
    ...
    consent: {
      ...
      backgroundCheckAccepted: { type: Boolean, required: true },
      acceptedAt: Date,
    },
    review: {
      reviewedBy: {
...
publicDriverOnboardingSchema.index({ status: 1, updatedAt: -1 });

module.exports = mongoose.model(
  "PublicDriverOnboarding",
  publicDriverOnboardingSchema,
);
